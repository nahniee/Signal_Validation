...
DATA_DIR = ROOT / "data"
DB_PATH = DATA_DIR / "signal_validation.db"
...
# Interpreter that has TF + yfinance (reused from Quant_Model_Research)
PYTHON = Path.home() / "Quant_Model_Research" / "tf-env" / "bin" / "python"

# --- Universe --------------------------------------------------------------
UNIVERSE_SIZE = 3000            # top-N US-listed equities by market cap (Russell 3000 proxy)
UNIVERSE_ASOF = "2026-09-14"    # screener snapshot date -> survivorship bias, see report §Limitations
...
CLAM_ORIGINAL_H5 = Path.home() / "Quant_Model_Research" / "quarterly_model.h5"
CLAM_ORIGINAL_SCALER = Path.home() / "Quant_Model_Research" / "quarterly_scaler.pkl"
